<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> 优化使用ONGL表达式，并引入新的标签库--%>
...
<script type="text/javascript">
	$(function(){
		//页面加载函数就会执行
		//页面加载，异步查询字典数据 $.post("",{},function(data){},"");
		//
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												<s:if test="currPage != totalPage"><!-- 在尾页时不应该有后一页跳跃的按钮 -->
